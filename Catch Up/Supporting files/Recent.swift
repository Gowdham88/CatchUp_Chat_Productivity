...
////    }
//
//    reference(.Recent).queryOrdered(byChild: kCHATROOMID).queryEqual(toValue: chatRoomId).observe(.value) { (snapshot) in
//
//        guard let snap = snapshot as DataSnapshot? else { return }
//
//        if (snap.value != nil)  {
//
//            for recent in snap.value as! NSDictionary {
//                
//                let currentRecent = recent.value as! NSDictionary
//                
//                if let currentUserId = currentRecent[kUSERID] {
//                    
//                    if tempMembers.contains(currentUserId as! String) {
...
//    let localReference = reference(.Recent).childByAutoId()
////    let recentId = localReference.documentID
//    let recentId = localReference.key
...
//    localReference.setValue(recent)
//}
//
//
////Restart Chat
